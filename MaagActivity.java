...
public class MaagActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View customView = inflater.inflate(R.layout.custom_layout_rician_maag,null);
        ...
        nButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Inflate the custom layout/view
                View customView = inflater.inflate(R.layout.custompenangananmaag,null);
            ...
            public void onClick(View view) {
                ...
                off.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder= new AlertDialog.Builder(MaagActivity.this);
                ...
                home.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i=new Intent(MaagActivity.this, MainActivity.class); //pindah halaman
                        startActivity(i);
                    }
                });
//
